      ...
      <div class="container">
        <div class="row">
			...
			//	include "config.php";
			  ...
			  $sql = "SELECT post.post_id,post.title,post.description,post.category,post.post_date,post.author,category.category_name,user.username,post.post_img 
			  ...
			  if(mysqli_num_rows($result)>0){
			   while($row = mysqli_fetch_assoc($result)){ 
			    ...
			    $result1 = mysqli_query($conn,$sql1)or die("Query failed 1st");
					...
					if($page>1){
						echo '<li><a href = "index.php?page='.($page-1).'&search='.$search_term.'">Prev</a></li>';
					}
