      ...
      <div class="container">
        <div class="row">
			...
			//	include "config.php";
			  ...
			  $sql = "SELECT post.post_id,post.title,post.description,post.category,post.post_date,post.author,category.category_name,user.username,post.post_img,post.author 
