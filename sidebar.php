<div id="sidebar" class="col-md-4">
    ...
    <div class="recent-post-container">
		...
		<?php 
			  ...
			  $sql = "SELECT post.post_id,post.title,post.description,post.category,post.post_date,post.author,category.category_name,post.post_img,post.author
			  ...
			  $result = mysqli_query($conn ,$sql)or die("Query :recent post fail");
